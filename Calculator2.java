...
//                System.out.println("Оба числа - арабские");
            ...
            try{
                ...
                try {
//                    System.out.println("оба римские");
                    ...
                    if (result <= 0) { //если число отрицательное, выйдет ошибка
                        System.out.println("№4: итог выражения - отрицательное число или ноль");
//                    } else if ((an < 1) || (bn < 1)) { //если одно из них больше 10 или меньше 1, то выйдет следующая ошибка:
//                        System.out.println("№5: одно или оба числа не принадлежат интервалу [1,10]");
//                    } else if ((an > 10) || (bn > 10)) { //если одно из них больше 10 или меньше 1, то выйдет следующая ошибка:
//                        System.out.println("№6: одно или оба числа не принадлежат интервалу [1,10]");
                    } else if ((1 <= an && an <= 10) && (1 <= bn && bn <= 10)) { //если числа подходящие, то выведется результат в римских числах
                    ...
                    System.out.println("№7: одно или оба числа не принадлежат интервалу [1,10]");
                }
            }
        }
    }
